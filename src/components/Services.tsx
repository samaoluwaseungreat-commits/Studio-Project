...
export function Services() {
  return (
    <section id="services" className="relative py-32 bg-brand-bg overflow-hidden border-t border-brand-text/5">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="mb-24 md:w-1/2">
          ...
          <p className="text-3xl md:text-5xl font-display font-light text-brand-text/90">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative">
                <span className="text-7xl font-display font-bold text-brand-text/5 group-hover:text-brand-purple/20 transition-colors duration-500 block mb-6">
                  {service.id}
                </span>
                <h3 className="text-2xl font-display font-semibold text-brand-text/90 mb-4 group-hover:text-brand-purple transition-colors duration-300">
                  {service.title}
                </h3>
